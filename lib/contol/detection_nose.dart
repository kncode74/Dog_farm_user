...
class DetectionNose extends StatefulWidget {
  const DetectionNose({super.key});

  @override
  State<DetectionNose> createState() => _DetectionNoseState();
}

class _DetectionNoseState extends State<DetectionNose> {
  bool _loading = true;
  File? _image;
  List _output = [];
                          ...
                          ? InkWell(
                              ...
                              child: Padding(
                                padding: const EdgeInsets.only(
                                    left: 110, right: 50, top: 10, bottom: 20),
                                child: ListTile(
                                  leading: Image.asset(
                                    'images/detect.png',
                                    height: 50,
